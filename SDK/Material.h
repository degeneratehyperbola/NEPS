...
public:
	...
	VIRTUAL_METHOD(void, setValue, 5, (int value), (this, value))
	VIRTUAL_METHOD(void, setValue, 6, (const char *value), (this, value))
...
public:
	...
	VIRTUAL_METHOD(void, getMaterialVarFlag, 30, (MaterialVarFlag flag), (this, flag))
	VIRTUAL_METHOD(bool, isErrorMaterial, 42, (), (this))
	VIRTUAL_METHOD(float, getAlphaModulation, 44, (), (this))
